                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" placeholder="Resume brevemente el perfil o servicio que estás buscando." maxlength="490" rows="4" class="form-control" required>{{ isset($offer_copy) ? $offer_copy->description : '' }}</textarea>
                            </div>
                        </div>
                    </div>
