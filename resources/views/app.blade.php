                ...
                <div class="container-fluid">
                    <div class="main-header-left ">
                        <div class="responsive-logo">
                            <a href="{{ route('profile.get') }}"><img src="{{ URL::asset('/images/Logo1.png') }}"
                                    class="logo-1" alt="logo"></a>
                            <a href="index.html"><img src="{{ URL::asset('/assets/img/brand/logo-white.png') }}"
                                    class="dark-logo-1" alt="logo"></a>
                            <a href="index.html"><img src="{{ URL::asset('/images/Logo1.png') }}" class="logo-2"
                                    alt="logo"></a>
    ...
    <script type="text/javascript">
        $(window).on('load', function() {
            ...
            $("#aceptar_politica").on("click", function() {
                ...
                $.post("{{ route('aceptar_politicas.post') }}", {
                    "_token": "{{ csrf_token() }}",
                    user_id: {{ session('user_id') }},
                    version: {{ session('politica_actual') }}
                }, function(result) {
                    //alert("guardado!!");
                });
            })
