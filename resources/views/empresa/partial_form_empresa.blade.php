...
<div class="row row-sm">
    ...
    <div class="col-lg-4">
        <p class="mg-b-10">Tipo documento</p><select class="form-control select2" name="tipo_documento_id" placeholder="Tipo Documento" required>
            <option value=""></option>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <input name="nit" class="form-control" value="{{isset($empresa['nit'])? $empresa['nit']:''}}" placeholder="Número Identificación" type="text" required>
        </div>
    </div>
    <div class="col-lg-2">
        <div class="form-group">
            <label for="digito_verificacion">Dígito Verificación</label>
            <input name="digito_verificacion" class="form-control" value="{{isset($empresa['digito_verificacion'])? $empresa['digito_verificacion']:''}}" placeholder="Dígito de Verifiación" type="text" required>
        </div>
    </div>
</div>
...
<div class="row row-sm">
   ...
   <div class="col-lg-6">
       <p class="mg-b-10">Regimen</p><select class="form-control select2" name="regimen_id" placeholder="Regimen" required>
           <option value=""></option>
   ...
   <div class="col-lg-6">
       <p class="mg-b-10">Actividad económica CIIU</p><select class="form-control select2" name="actividad_economica_id" placeholder="Actividad Económica" required>
           <option value=""></option>
...
<div class="row row-sm">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            <label>Correo para factura electrónica</label> <input class="form-control" name="email_factura_electronica" value="{{isset($empresa['email_factura_electronica'])? $empresa['email_factura_electronica']:''}}" placeholder="Correo para factura electrónica" type="email" required>
        </div>
    </div>
</div>
